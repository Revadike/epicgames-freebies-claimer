...
try {
    ...
    unlink(`${__dirname}/device_auths.json`);
    writeFile(`${__dirname}/deviceAuths.json`, JSON.stringify(DeviceAuths, null, 4));
...
async function saveDeviceAuth(email, deviceAuth) {
    ...
    await writeFile(`${__dirname}/deviceAuths.json`, JSON.stringify(DeviceAuths, null, 4));
