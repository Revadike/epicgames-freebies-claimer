...
const Auths = require(`${__dirname}/data/token/device_auths.json`);
const CheckUpdate = require("check-update-github");
const Config = require(`${__dirname}/data/config/config.json`);
const History = require(`${__dirname}/data/history/history.json`);
...
(async() => {
    ...
    do {
        ...
        await write(`${__dirname}/data/history/history.json`, JSON.stringify(History, null, 4));
        if (loop) {
